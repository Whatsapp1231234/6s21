...
global.dfail = (type, m, conn) => {
    let msg = {
            ...
            owner: 'Эту команду может использовать только мой создатель 😝',
        ...
        group: 'Эту команду можно использовать только в группах 👥',
            ...
            admin: 'Эту команду могут использовать только админы 🫅',
        botAdmin: 'Чтобы ипользовать эту команду нужно дать права администратора боту 🎃',
            unreg: lenguajeGB['smsUnreg'](),
            restrict: lenguajeGB['smsRestrict'](),
    }[type]
    let tg = { quoted: m, userJid: conn.user.jid }
    let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: lenguajeGB.smsAvisoAG().slice(0,-2), body: [wm, gt + '❕', '❕'].getRandom(), thumbnail: gataImg.getRandom(), sourceUrl: [md, nna, nn, nnn, yt, ig, paypal, fb].getRandom() }}}}, tg)
